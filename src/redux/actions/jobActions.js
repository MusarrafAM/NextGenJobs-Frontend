...
export const getAllJobs = () => async (dispatch) => {
  ...
  try {
    ...
    const response = await axios.get(`${baseUrl}/api/jobs/getalljobs`);
...
export const postJob = (values) => async (dispatch) => {
  ...
  dispatch({ type: "LOADING", payload: true });
  try {
    await axios.post(`${baseUrl}/api/jobs/postjob`, values);
...
export const editJob = (values) => async (dispatch) => {
  dispatch({ type: "LOADING", payload: true });
  try {
    await axios.post(`${baseUrl}/api/jobs/editjob`, values);
...
export const applyJob = (job) => async (dispatch) => {
  ...
  dispatch({ type: "LOADING", payload: true });
  try {
    await axios.post(`${baseUrl}/api/jobs/applyjob`, { job, user });
...
export const deleteJob = (jobId) => async (dispatch) => {
  dispatch({ type: "LOADING", payload: true });
  try {
    await axios.delete(`${baseUrl}/api/jobs/deletejob/${jobId}`);
...
export const disableJob = (jobId) => async (dispatch) => {
  ...
  try {
    await axios.post(`${baseUrl}/api/jobs/updatejobdisabled/${jobId}`, {
      isDisabled: true,
    });
